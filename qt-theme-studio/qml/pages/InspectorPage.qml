    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            SectionCard {
                Layout.fillWidth: true
                title: "Coming next"
                subtitle: "The existing TUI still owns deeper component editors, comparisons, search, recovery, and theme-management flows while they are migrated page by page."
