...
ApplicationWindow {
    ...
    function syncTheme() { Theme.applyEngine(themeBridge.name, themeBridge.colorsJson, themeBridge.dark, themeBridge.fontFamily, themeBridge.uiMetricsJson, themeBridge.uiPatternsJson) }
