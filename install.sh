...
# Qt frontend source is installed as ordinary files. PySide6 itself stays
# optional so re-running install.sh remains lightweight; `theme qt-install`
# creates the managed runtime when the user wants the GUI.
